...
public class StaffDash extends javax.swing.JFrame {
    ...
    public StaffDash() {
      ...
      public StaffDash( String userName, String Password) {
        initComponents();
          username=userName;
        password=Password;
         setExtendedState(JFrame.MAXIMIZED_BOTH);
          try{
            ...
            ResultSet rs=st.executeQuery("select *from staff where username='"+username+"'and password='"+password+"'");
       if(rs.next()){
            id=rs.getString(1);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1600, 20, 120, 40));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1580, 110, -1, -1));
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1360, 120, 185, -1));
        ...
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1650, 120, 200, -1));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1360, 220, 140, 60));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 310, 890, 480));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 310, 770, 480));
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1730, 20, 110, 40));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(1260, 110, -1, -1));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1610, 810, 140, 60));
...
int productTotal;
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField5.setText(model.getValueAt(Myindex, 3).toString());
         intValue = Integer.parseInt(model.getValueAt(Myindex, 2).toString());
...
int i =1;
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int newQuantity= intValue - quantity;
        if(newQuantity<1){
            JOptionPane.showMessageDialog(null,"Quantity cannot be more than stock");
        }
        System.out.println(intValue);
        if(id.isEmpty()|| productID.isEmpty() || item.isEmpty())
            ...
            if(rs.next()){
                ResultSet rsl=st.executeQuery("select  *from staff where id='"+id+"'");
                if(rsl.next()){
                          
           
           PreparedStatement st1 = con.prepareStatement("insert into sold(user_id,product_id,item,quantity,price,product_total) values (?,?,?,?,?,?)");

                    st1.setString(1, id);
                    st1.setString(2, productID);
                    st1.setString(3, item);
                    st1.setInt(4, quantity);
                    st1.setInt(5, price);
                    st1.setInt(6, productTotal);
                    st1.executeUpdate();
             st1.executeUpdate("update products set quantity='"+newQuantity+"' where id='"+productID+"'");
                           
        
        
//                   st.executeUpdate("insert into sold values('"+id+"','"+productID+"','"+item+"','"+quantity+"','"+price+"','"+productTotal+"')");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        dispose();
         new StaffDash(username,password).setVisible(true);
